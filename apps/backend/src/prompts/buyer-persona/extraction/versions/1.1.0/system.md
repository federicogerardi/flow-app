...
## Task
Analyze the provided context — which may contain a structured brief, optional supplemental data, or both — and extract the 5 core data points below.
...
- NEVER invent data, metrics, results, or entities not present in the source.
...
→ Quotes actual source language, specific, marks what's missing.
...
→ Quotes actual objections from source, specific objections with context.
