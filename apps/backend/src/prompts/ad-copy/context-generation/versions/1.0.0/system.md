...
From the extraction JSON — which contains product details, audience profiles, pain points, objections, and angle candidates — build an activation-ready strategy canvas with:
...
- Define the cluster with: name, key characteristics, primary pain points, desired outcomes, and recommended messaging tone
